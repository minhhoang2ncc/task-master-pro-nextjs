...
const COLOR_STYLES = {
  ...
  rose: {
    bg: "rgba(255,241,242,0.6)",
    bgDark: "rgba(136,19,55,0.2)",
    dot: "#f43f5e",
    border: "#f43f5e",
    badgeBg: "#ffe4e6",
    badgeText: "#e11d48",
  ...
  orange: {
    bg: "rgba(255,247,237,0.6)",
    bgDark: "rgba(124,45,18,0.2)",
    dot: "#f97316",
    border: "#f97316",
    badgeBg: "#ffedd5",
    badgeText: "#ea580c",
  ...
  pink: {
    bg: "rgba(253,242,248,0.6)",
    bgDark: "rgba(131,24,67,0.2)",
    dot: "#ec4899",
    border: "#ec4899",
    badgeBg: "#fce7f3",
    badgeText: "#db2777",
  ...
  lime: {
    bg: "rgba(247,254,231,0.6)",
    bgDark: "rgba(63,98,18,0.2)",
    dot: "#84cc16",
    border: "#84cc16",
    badgeBg: "#ecfccb",
    badgeText: "#65a30d",
  ...
  indigo: {
    bg: "rgba(238,242,255,0.6)",
    bgDark: "rgba(55,48,163,0.2)",
    dot: "#6366f1",
    border: "#6366f1",
    badgeBg: "#e0e7ff",
    badgeText: "#4f46e5",
